    ...
    return(
      ...
      <View style={styles.modalBackButton}>
        ...
        <View style={styles.modalBackButton}>
          ...
          >
          <Text style={{color:'#ff5722', fontWeight:'bold'}}>Cancel</Text>
          </TouchableOpacity>
        </View>
  ...
  render(){
    return(
      <View style={styles.container}>
        ...
        <View style={styles.profileContaineer}>
...
const styles = StyleSheet.create({ 
  ...
  registerButton:{ margin:30 ,width:200, height:30, alignItems:'center', justifyContent:'center', borderWidth:1, borderRadius:10, marginTop:30 }, 
  registerButtonText:{ color:'#ff5722', fontSize:15, fontWeight:'bold'}, 
  cancelButton:{margin: 30, width:200, height:30, justifyContent:'center', alignItems:'center', borderWidth:1, borderRadius:10,marginTop:5, }, 
